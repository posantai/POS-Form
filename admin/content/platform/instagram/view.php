...
<div class="">
   ...
   <div class="col-md-4">
        <a href="?page=instagram&action=hapus&id=<?php echo $id; ?>" class="btn btn-primary" onClick="confirm('Apakah yakin ingin menghapus data ini?')">Hapus</a>
        <a href="?page=instagram" class="btn btn-danger">Kembali</a>
        <br><br><br>
   </div>
