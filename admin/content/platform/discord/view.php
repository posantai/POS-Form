...
<div class="x_content">
   ...
   <div class="col-md-4">
        <a href="?page=discord&action=hapus&id=<?php echo $id; ?>" class="btn btn-primary" onClick="confirm('Apakah yakin ingin menghapus data ini?')">Hapus</a>
        <a href="?page=discord" class="btn btn-danger">Kembali</a>
        <br><br><br>
   </div>
          </div>
         </div>
