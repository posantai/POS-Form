              ...
              <table class="table table-striped jambo_table bulk_action">
                ...
                <tbody>
                    ...
                    <td class="bulk_action">
                      <a href="?page=discord&action=view&id=<?=$data['calon_id']?>">View</a> |
                      <a href="?page=discord&action=hapus&id=<?=$data['calon_id']?>" onClick='return confirm("Apakah kamu yakin menghapus data ini?")'>Delete</a>
                    </td>
                  </tr>
                  <?php
                        }
